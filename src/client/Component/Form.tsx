        ...
        return (
            <main className="container">
                ...
                >
                    ...
                    <input type="text" placeholder="What is your name?" value={this.state.name} onChange={(e: React.ChangeEvent<HTMLInputElement>) => this.setState({ name: e.target.value })} className="form-control border border-dark" />
                    <label className="m-2">Amount</label>
                    <input type="text" placeholder="How much?" value={this.state.amount} onChange={(e: React.ChangeEvent<HTMLInputElement>) => this.setState({ amount: e.target.value })} className="form-control border border-dark" />
